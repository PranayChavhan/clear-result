...
const NewsLetterCard = () => {
  ...
  return (
    <View className={`w-screen pr-10 mr-3`}>
      <View className=" bg-white h-auto pb-4 flex flex-col overflow-hidden rounded-3xl">
        <View className="h-32 relative rounded-3xl p-0 overflow-hidden">
          <Image
            source={require("../assets/images/bg_newsletter.png")}
            resizeMode="cover"
            className={`h-full w-full`}
          />
          <Image
            source={require("../assets/images/trending_badge.png")}
            resizeMode="cover"
        ...
        <View className="px-4 py-2 gap-y-1">
          ...
          <View className="flex-row ">
            <Text
              className={
                "text-sm text-amber-400  font-semibold text-ellipsis line-clamp-2"
              }
            ...
            <Text
              ...
              style={{ fontFamily: "Poppins-Regular" }}
            >
              Get daily news letter on your email
            </Text>
          </View>
          <Text
            className={"text-sm font-semibold text-ellipsis line-clamp-2"}
