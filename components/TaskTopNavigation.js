  ...
  return (
    <Tab.Navigator
      tabBarOptions={{
        ...
        indicatorStyle: { backgroundColor: '#2F80ED', width:0.55, height: 3, marginBottom: -1 },
      ...
      <View className="bg-white h-screen px-4 pt-4">
        ...
        <View className="border-[0.8px] border-gray-300 p-4 rounded-lg mb-4">
            <View className="flex flex-row items-start justify-between">
                <View>
                    <Text className="text-[18px] font-bold">Follow up mode:Calling</Text>
                    <Text className="text-[12px] italic text-[#828282] mt-1">Anisha Mulay : AM Studio</Text>
                </View>
                <View>
                    <IcCall/>
                </View>
            ...
            <View className="flex flex-row items-center justify-between border-t-[0.8px] border-gray-300 mt-4 pt-1">
                <View className="flex flex-row items-center gap-1">
                    <IcCalendar/>
                    <Text className="text-[14px] text-[#828282]">Mon, 10 July 2022</Text>
                </View>
                <View>
                    <Avatar01/>
                </View>
        ...
        <View className="border-[0.8px] border-gray-300 p-4 rounded-lg mb-4">
            <View className="flex flex-row items-start justify-between">
                <View>
                    <Text className="text-[18px] font-bold">Follow up mode:Calling</Text>
                    <Text className="text-[12px] italic text-[#828282] mt-1">Rahul Shah : H&M</Text>
                </View>
                <View>
                    <IcCall/>
                </View>
        ...
        <Text className="text-[12px] italic text-[#828282] absolute bottom-[30%] left-[39%]">Powered by ClearResults</Text>
      </View>
    );
  };
