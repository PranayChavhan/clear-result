...
import ExhibitionInfoTopNav from "../../components/admin/ExhibitionInfoTop";

const ExhibitionInfoScreen = () => {
  ...
  return (
    <Screen className="bg-white">
      ...
      <View className="px-4 py-3">
        <Text className="text-[18px] font-[500]">Exhibition Name 1</Text>
      </View>
      <ExhibitionInfoTopNav />
...
export default ExhibitionInfoScreen;
