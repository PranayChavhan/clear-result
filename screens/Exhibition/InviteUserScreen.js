...
{/*   
  ...
  const Location = () => {
    ...
    return (
      <View>
<Text className="text-[12px] font-bold text-[#828282]">Search States</Text>
<View className="w-56 mb-6 mt-2 flex flex-row items-center border border-blue-300 p-2 rounded-lg">
    <View className="mr-2"><IcSearch/></View>
<TextInput
          className=" "
...
const InviteUserScreen = () => {
  ...
  return (
    <Screen className="bg-white">
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false} className="">
        ...
        <View className=" flex flex-row items-center justify-between px-4">
          {
            isFilterVisible ?
            <>
             <Text className="text-[18px] font-[500]">InviteesnFilters</Text>
            </>
            :
            <>
